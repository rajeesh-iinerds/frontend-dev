...
export class ProductdetailComponent implements OnInit {
	...
	cartBucket: any;
	cartItemIndex: any;
	constructor(private route: ActivatedRoute, private router: Router, public searchComponent: ProductSearchComponent, public demoService: DemoService, private http: Http, private dashboardComponent: DashboardComponentComponent, public searchProductService: SearchProductService) {
